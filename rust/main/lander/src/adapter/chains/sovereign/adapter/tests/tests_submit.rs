...
use super::tests_common::{adapter, payload, successful_submit_response, MockSovereignProvider};
...
async fn build_tx(adapter: &super::super::SovereignAdapter) -> crate::transaction::Transaction {
